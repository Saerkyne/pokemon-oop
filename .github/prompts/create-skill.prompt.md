...
- Accept input via **command-line arguments** (use `process.argv` in Node.js, `sys.argv` in Python, `$@` in Bash, maven/gradle args in Java, etc.)
...
- Keep dependencies minimal (use only widely available runtimes: Node.js, Python 3, Bash, etc.)
