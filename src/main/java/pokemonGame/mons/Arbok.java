...
public class Arbok extends Pokemon {
    ...
    static {
        ...
        LEARNSET.add(new LearnsetEntry(new Glare(), LearnsetEntry.Source.LEVEL, 27));
        LEARNSET.add(new LearnsetEntry(new Screech(), LearnsetEntry.Source.LEVEL, 36));
        LEARNSET.add(new LearnsetEntry(new Acid(), LearnsetEntry.Source.LEVEL, 47));
        // HM Moves
