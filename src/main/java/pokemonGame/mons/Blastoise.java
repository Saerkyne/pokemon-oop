...
public class Blastoise extends Pokemon {
    ...
    static {
        ...
        LEARNSET.add(new LearnsetEntry(new Bite(), LearnsetEntry.Source.LEVEL, 24));
        LEARNSET.add(new LearnsetEntry(new Withdraw(), LearnsetEntry.Source.LEVEL, 31));
        LEARNSET.add(new LearnsetEntry(new SkullBash(), LearnsetEntry.Source.LEVEL, 42));
