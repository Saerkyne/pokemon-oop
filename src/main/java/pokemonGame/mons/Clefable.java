...
public class Clefable extends Pokemon {
    ...
    static {
        // Level up moves
        LEARNSET.add(new LearnsetEntry(new Sing(), LearnsetEntry.Source.LEVEL, 1));
        LEARNSET.add(new LearnsetEntry(new DoubleSlap(), LearnsetEntry.Source.LEVEL, 1));
        LEARNSET.add(new LearnsetEntry(new Minimize(), LearnsetEntry.Source.LEVEL, 1));
        LEARNSET.add(new LearnsetEntry(new Metronome(), LearnsetEntry.Source.LEVEL, 1));

        // Pre-evolution moves
        LEARNSET.add(new LearnsetEntry(new Pound(), LearnsetEntry.Source.PRE_EVOLUTION, 1));
        LEARNSET.add(new LearnsetEntry(new Growl(), LearnsetEntry.Source.PRE_EVOLUTION, 1));
        LEARNSET.add(new LearnsetEntry(new DefenseCurl(), LearnsetEntry.Source.PRE_EVOLUTION, 1));
        LEARNSET.add(new LearnsetEntry(new LightScreen(), LearnsetEntry.Source.PRE_EVOLUTION, 1));
