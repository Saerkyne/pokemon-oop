...
public class Clefairy extends Pokemon {
    ...
    static {
        ...
        LEARNSET.add(new LearnsetEntry(new Sing(), LearnsetEntry.Source.LEVEL, 13));
        LEARNSET.add(new LearnsetEntry(new DoubleSlap(), LearnsetEntry.Source.LEVEL, 18));
        LEARNSET.add(new LearnsetEntry(new Minimize(), LearnsetEntry.Source.LEVEL, 24));
        LEARNSET.add(new LearnsetEntry(new Metronome(), LearnsetEntry.Source.LEVEL, 31));
        LEARNSET.add(new LearnsetEntry(new DefenseCurl(), LearnsetEntry.Source.LEVEL, 39));
