...
public class Drowzee extends Pokemon {
    ...
    static {
        ...
        LEARNSET.add(new LearnsetEntry(PoisonGas.INSTANCE, LearnsetEntry.Source.LEVEL, 29));
        LEARNSET.add(new LearnsetEntry(Psychic.INSTANCE, LearnsetEntry.Source.LEVEL, 32));
        LEARNSET.add(new LearnsetEntry(Meditate.INSTANCE, LearnsetEntry.Source.LEVEL, 37));
