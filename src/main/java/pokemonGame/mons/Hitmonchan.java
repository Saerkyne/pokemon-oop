...
public class Hitmonchan extends Pokemon {
    ...
    static {
        ...
        LEARNSET.add(new LearnsetEntry(new FirePunch(), LearnsetEntry.Source.LEVEL, 33));
        LEARNSET.add(new LearnsetEntry(new IcePunch(), LearnsetEntry.Source.LEVEL, 38));
        LEARNSET.add(new LearnsetEntry(new ThunderPunch(), LearnsetEntry.Source.LEVEL, 43));
        LEARNSET.add(new LearnsetEntry(new MegaPunch(), LearnsetEntry.Source.LEVEL, 48));
        LEARNSET.add(new LearnsetEntry(new Counter(), LearnsetEntry.Source.LEVEL, 53));
