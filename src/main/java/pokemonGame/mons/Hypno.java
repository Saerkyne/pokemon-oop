...
public class Hypno extends Pokemon {
    ...
    static {
        ...
        LEARNSET.add(new LearnsetEntry(new PoisonGas(), LearnsetEntry.Source.LEVEL, 33));
        LEARNSET.add(new LearnsetEntry(new Psychic(), LearnsetEntry.Source.LEVEL, 37));
        LEARNSET.add(new LearnsetEntry(new Meditate(), LearnsetEntry.Source.LEVEL, 43));
