...
public class Krabby extends Pokemon {
    ...
    static {
        ...
        LEARNSET.add(new LearnsetEntry(Crabhammer.INSTANCE, LearnsetEntry.Source.LEVEL, 35));
        LEARNSET.add(new LearnsetEntry(Harden.INSTANCE, LearnsetEntry.Source.LEVEL, 40));
