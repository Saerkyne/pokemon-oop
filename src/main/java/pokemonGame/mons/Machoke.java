...
public class Machoke extends Pokemon {
    ...
    static {
        ...
        LEARNSET.add(new LearnsetEntry(LowKick.INSTANCE, LearnsetEntry.Source.LEVEL, 1));
        ...
        LEARNSET.add(new LearnsetEntry(SeismicToss.INSTANCE, LearnsetEntry.Source.LEVEL, 44));
        LEARNSET.add(new LearnsetEntry(Submission.INSTANCE, LearnsetEntry.Source.LEVEL, 52));
