...
public class Machop extends Pokemon {
    ...
    static {
        ...
        LEARNSET.add(new LearnsetEntry(new LowKick(), LearnsetEntry.Source.LEVEL, 20));
        LEARNSET.add(new LearnsetEntry(new Leer(), LearnsetEntry.Source.LEVEL, 25));
        LEARNSET.add(new LearnsetEntry(new FocusEnergy(), LearnsetEntry.Source.LEVEL, 32));
        LEARNSET.add(new LearnsetEntry(new SeismicToss(), LearnsetEntry.Source.LEVEL, 39));
        LEARNSET.add(new LearnsetEntry(new Submission(), LearnsetEntry.Source.LEVEL, 46));
