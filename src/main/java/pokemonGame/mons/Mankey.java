...
public class Mankey extends Pokemon {
    ...
    static {
        ...
        LEARNSET.add(new LearnsetEntry(SeismicToss.INSTANCE, LearnsetEntry.Source.LEVEL, 33));
        LEARNSET.add(new LearnsetEntry(Thrash.INSTANCE, LearnsetEntry.Source.LEVEL, 39));
