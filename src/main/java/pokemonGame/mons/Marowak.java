...
public class Marowak extends Pokemon {
    ...
    static {
        // Level up moves
        LEARNSET.add(new LearnsetEntry(new BoneClub(), LearnsetEntry.Source.LEVEL, 1));
        LEARNSET.add(new LearnsetEntry(new FocusEnergy(), LearnsetEntry.Source.LEVEL, 1));
        ...
        LEARNSET.add(new LearnsetEntry(new Leer(), LearnsetEntry.Source.LEVEL, 25));
        LEARNSET.add(new LearnsetEntry(new FocusEnergy(), LearnsetEntry.Source.LEVEL, 33));
        LEARNSET.add(new LearnsetEntry(new Thrash(), LearnsetEntry.Source.LEVEL, 41));
        LEARNSET.add(new LearnsetEntry(new Bonemerang(), LearnsetEntry.Source.LEVEL, 48));
        LEARNSET.add(new LearnsetEntry(new Rage(), LearnsetEntry.Source.LEVEL, 55));
