...
public class Mewtwo extends Pokemon {
    ...
    static {
        ...
        LEARNSET.add(new LearnsetEntry(Psychic.INSTANCE, LearnsetEntry.Source.LEVEL, 1));
        LEARNSET.add(new LearnsetEntry(Swift.INSTANCE, LearnsetEntry.Source.LEVEL, 1));
        LEARNSET.add(new LearnsetEntry(Barrier.INSTANCE, LearnsetEntry.Source.LEVEL, 63));
        LEARNSET.add(new LearnsetEntry(Psychic.INSTANCE, LearnsetEntry.Source.LEVEL, 66));
        LEARNSET.add(new LearnsetEntry(Recover.INSTANCE, LearnsetEntry.Source.LEVEL, 70));
        LEARNSET.add(new LearnsetEntry(Mist.INSTANCE, LearnsetEntry.Source.LEVEL, 75));
        LEARNSET.add(new LearnsetEntry(Amnesia.INSTANCE, LearnsetEntry.Source.LEVEL, 81));
