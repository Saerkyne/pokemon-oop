...
public class Nidoking extends Pokemon {
    ...
    static {
        ...
        LEARNSET.add(new LearnsetEntry(Thrash.INSTANCE, LearnsetEntry.Source.LEVEL, 1));
        ...
        LEARNSET.add(new LearnsetEntry(Thrash.INSTANCE, LearnsetEntry.Source.LEVEL, 23));

        LEARNSET.add(new LearnsetEntry(DoubleKick.INSTANCE, LearnsetEntry.Source.PRE_EVOLUTION, 0));
        LEARNSET.add(new LearnsetEntry(FocusEnergy.INSTANCE, LearnsetEntry.Source.PRE_EVOLUTION, 0));
        LEARNSET.add(new LearnsetEntry(FuryAttack.INSTANCE, LearnsetEntry.Source.PRE_EVOLUTION, 0));
        LEARNSET.add(new LearnsetEntry(HornDrill.INSTANCE, LearnsetEntry.Source.PRE_EVOLUTION, 0));
        LEARNSET.add(new LearnsetEntry(Leer.INSTANCE, LearnsetEntry.Source.PRE_EVOLUTION, 0));
