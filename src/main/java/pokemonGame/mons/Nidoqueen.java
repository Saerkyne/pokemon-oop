...
public class Nidoqueen extends Pokemon {
    ...
    static {
        ...
        LEARNSET.add(new LearnsetEntry(new BodySlam(), LearnsetEntry.Source.LEVEL, 23));
        ...
        LEARNSET.add(new LearnsetEntry(new FurySwipes(), LearnsetEntry.Source.PRE_EVOLUTION, 0));
        LEARNSET.add(new LearnsetEntry(new Growl(), LearnsetEntry.Source.PRE_EVOLUTION, 0));
