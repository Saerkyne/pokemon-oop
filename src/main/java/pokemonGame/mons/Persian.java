...
public class Persian extends Pokemon {
    ...
    static {
        ...
        LEARNSET.add(new LearnsetEntry(FurySwipes.INSTANCE, LearnsetEntry.Source.LEVEL, 37));
        LEARNSET.add(new LearnsetEntry(Slash.INSTANCE, LearnsetEntry.Source.LEVEL, 51));
