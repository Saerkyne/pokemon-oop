...
public class Poliwhirl extends Pokemon {
    ...
    static {
        ...
        LEARNSET.add(new LearnsetEntry(new DoubleSlap(), LearnsetEntry.Source.LEVEL, 26));
        LEARNSET.add(new LearnsetEntry(new BodySlam(), LearnsetEntry.Source.LEVEL, 33));
        LEARNSET.add(new LearnsetEntry(new Amnesia(), LearnsetEntry.Source.LEVEL, 41));
