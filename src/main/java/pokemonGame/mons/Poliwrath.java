...
public class Poliwrath extends Pokemon {
    ...
    static {
        ...
        LEARNSET.add(new LearnsetEntry(Amnesia.INSTANCE, LearnsetEntry.Source.PRE_EVOLUTION, 0));
        LEARNSET.add(new LearnsetEntry(Bubble.INSTANCE, LearnsetEntry.Source.PRE_EVOLUTION, 0));
