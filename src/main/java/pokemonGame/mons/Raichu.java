...
public class Raichu extends Pokemon {
    ...
    static {
        ...
        LEARNSET.add(new LearnsetEntry(new Agility(), LearnsetEntry.Source.PRE_EVOLUTION, 0));
        LEARNSET.add(new LearnsetEntry(new QuickAttack(), LearnsetEntry.Source.PRE_EVOLUTION, 0));
        LEARNSET.add(new LearnsetEntry(new Swift(), LearnsetEntry.Source.PRE_EVOLUTION, 0));
        LEARNSET.add(new LearnsetEntry(new Thunder(), LearnsetEntry.Source.PRE_EVOLUTION, 0));
