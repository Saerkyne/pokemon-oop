...
public class Starmie extends Pokemon {
    ...
    static {
        ...
        LEARNSET.add(new LearnsetEntry(new LightScreen(), LearnsetEntry.Source.PRE_EVOLUTION, 0));
        LEARNSET.add(new LearnsetEntry(new Minimize(), LearnsetEntry.Source.PRE_EVOLUTION, 0));
        LEARNSET.add(new LearnsetEntry(new Recover(), LearnsetEntry.Source.PRE_EVOLUTION, 0));
        LEARNSET.add(new LearnsetEntry(new Swift(), LearnsetEntry.Source.PRE_EVOLUTION, 0));
