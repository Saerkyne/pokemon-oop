...
public class Vileplume extends Pokemon {
    ...
    static {
        ...
        LEARNSET.add(new LearnsetEntry(PetalDance.INSTANCE, LearnsetEntry.Source.LEVEL, 1));
        ...
        LEARNSET.add(new LearnsetEntry(Absorb.INSTANCE, LearnsetEntry.Source.PRE_EVOLUTION, 0));
