...
public class Wigglytuff extends Pokemon {
    ...
    static {
        LEARNSET.add(new LearnsetEntry(new DefenseCurl(), LearnsetEntry.Source.LEVEL, 1));
        ...
        LEARNSET.add(new LearnsetEntry(new BodySlam(), LearnsetEntry.Source.PRE_EVOLUTION, 0));
        LEARNSET.add(new LearnsetEntry(new DoubleEdge(), LearnsetEntry.Source.PRE_EVOLUTION, 0));
        LEARNSET.add(new LearnsetEntry(new Pound(), LearnsetEntry.Source.PRE_EVOLUTION, 0));
        LEARNSET.add(new LearnsetEntry(new Rest(), LearnsetEntry.Source.PRE_EVOLUTION, 0));
    ...
    public Wigglytuff(String nickname) {
        super(
            "Wigglytuff",
            40,
            "Normal",
